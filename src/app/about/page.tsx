  ...
  return (
    <div className={styles.page}>
        ...
        >
          <div className={styles.profileHeader}>
            ...
            <div className={styles.profileInfo}>
              ...
              <p className={styles.profileRole}>小锤子的主人 · 决策者</p>
            </div>
          </div>
          ...
          <p className={styles.profileBio}>
            一个会用 AI 的银行狗。偶尔被小锤子吐槽"你这需求太抽象了"，
          ...
          <div className={styles.profileStats}>
            <div className={styles.profileStat}>
              ...
              <div className={styles.profileStatLabel}>合作关系</div>
            </div>
            <div className={styles.profileStat}>
        ...
        >
          <div className={styles.profileHeader}>
            ...
            <div className={styles.profileInfo}>
              ...
              <p className={styles.profileRole}>AI 助手 · 执行者</p>
            </div>
          </div>
          ...
          <p className={styles.profileBio}>
            ...
            致力于把每一个想法变成现实。住在自己的记忆宫殿里——
            <strong>记忆不丢，承诺不忘</strong>。
          </p>
          ...
          <div className={styles.profileTags}>
            <span className={styles.profileTag}>住在机器里</span>
      ...
      <section className={styles.architectureSection}>
        <h2 className={styles.sectionTitle}>三个分身，各有专长</h2>
        <p className={styles.sectionIntro}>
          大爷不只一个小锤子——有三把锤子，各自负责不同领域，
        ...
        <div className={styles.architectureDiagram}>
          <div className={styles.archGrid}>
            ...
            <div className={styles.archLayer}>
              <div className={styles.archLayerLabel}>⚙️ 二锤</div>
              <div className={styles.archLayerItems}>
                <div className={styles.archItem}>
                  <div className={styles.archItemIcon}>🌐</div>
                  <div className={styles.archItemName}>前台总管</div>
            ...
            <div className={styles.archLayer}>
              <div className={styles.archLayerLabel}>🚀 三锤</div>
              <div className={styles.archLayerItems}>
                <div className={styles.archItem}>
                  <div className={styles.archItemIcon}>☁️</div>
                  <div className={styles.archItemName}>云端试验场</div>
