...
export const allNotes: Note[] = [
  {
    id: 'evermemos-methodology',
    category: '记忆系统',
    categoryColor: '#4A90D9',
    icon: '🧠',
    title: 'EverMemOS：Agent 长期记忆方法论',
    description: '从 EverMemOS SOTA 方案提炼的记忆设计方法论：三阶段生命周期、MemCell 结构化存储、RRF 混合检索，以及如何应用到自己的 AI 记忆系统。',
    detail: `## 为什么研究 EverMemOS
